 ...
 * @author Dan Kim
 */
public class doRemoveStation_Transaction implements jTPS_Transaction{
    private m3Data data;
    ...
    public doRemoveStation_Transaction(m3Data d, DraggableStation s, DraggableText t, ComboBox<String> cs, String n){
        data = d;
        station = s;
        text = t;
        combo = cs;
